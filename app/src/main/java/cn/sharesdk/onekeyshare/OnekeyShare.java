...
public class OnekeyShare implements PlatformActionListener, Callback
{
    ...
    {
        return shareParamsMap.containsKey("text")
                ? String.valueOf(shareParamsMap.get("text")) : null;
    }
                ...
                .entrySet())
        {
            ...
            if (imagePath != null && (new File(imagePath)).exists())
            {
                        ...
                        && !TextUtils.isEmpty(data.get("url").toString()))
                {
                    ...
                    if (data.containsKey("musicUrl") && !TextUtils
                            .isEmpty(data.get("musicUrl").toString()))
                    {
            ...
            else
            {
                ...
                else
                {
                            ...
                            && !TextUtils.isEmpty(String.valueOf(imageUrl)))
                    {
                        ...
                        else if (data.containsKey("url") && !TextUtils
                                .isEmpty(data.get("url").toString()))
                        {
                            shareType = Platform.SHARE_WEBPAGE;
                            if (data.containsKey("musicUrl") && !TextUtils
                                    .isEmpty(data.get("musicUrl").toString()))
