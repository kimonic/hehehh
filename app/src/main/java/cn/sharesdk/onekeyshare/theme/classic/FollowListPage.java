        ...
        implements OnClickListener, OnItemClickListener
{
            ...
            implements PlatformActionListener, Callback
    {
        ...
        public FollowAdapter(PullToRefreshView view)
        {
            ...
            if (resId > 0)
            {
                bmChd = BitmapFactory.decodeResource(view.getResources(),
                        resId);
            }
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                ...
                int dp_10 = com.mob.tools.utils.R.dipToPx(parent.getContext(),
                        10);
                int dp_5 = com.mob.tools.utils.R.dipToPx(parent.getContext(),
                        5);
        ...
        {
            FollowersResult followersResult = parseFollowers(platform.getName(),
                    res, map);
