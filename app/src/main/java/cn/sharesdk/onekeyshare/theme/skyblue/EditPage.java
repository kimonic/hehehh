        ...
        implements OnClickListener, TextWatcher
{
    ...
    private void initView()
    {
        if (!dialogMode)
        {
            RelativeLayout mainRelLayout = findViewByResName(
                    "mainRelLayout");
    ...
    private void initBodyView()
    {
        ...
        textCounterTextView = findViewByResName(
                "textCounterTextView");
    ...
    {
        final HorizontalScrollView hScrollView = findViewByResName(
                "hScrollView");
        ImageListResultsCallback callback = new ImageListResultsCallback()
        {
            ...
            public void onFinish(ArrayList<ImageInfo> results)
            {
                if (results == null)
                    return;
                LinearLayout layout = findViewByResName(
                        "imagesLinearLayout");
    ...
    private View makeImageItemView(final ImageInfo imageInfo)
    {
        ...
        ImageView imageView = (ImageView) view
                .findViewById(getIdRes(activity, "imageView"));
