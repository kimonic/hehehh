        ...
        implements View.OnClickListener
{
    ...
    public View getView(int position, View view, ViewGroup viewGroup)
    {
        ...
        if (view == null)
        {
            ...
            viewHolder.logoImageView = (ImageView) view
                    .findViewById(getIdRes(context, "logoImageView"));
        ...
        boolean disabled;
        boolean isDirectShare = item instanceof Platform
                ? ShareCore.isDirectShare((Platform) item) : true;
        ...
        viewHolder.checkedImageView
                .setVisibility(checkedPositionList.contains(viewHolder.position)
