        ...
        implements PullToRefreshBase.OnPullEventListener<V>
{
    ...
    @Override
    public final void onPullEvent(PullToRefreshBase<V> refreshView, State event,
            Mode direction)
    {
