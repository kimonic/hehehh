...
public class HuiFuCashActivity extends BaseActivity implements OnClickListener
{
    ...
    private class WebClient extends WebChromeClient
    {
        ...
        public void onProgressChanged(WebView view, int newProgress)
        {
            ...
            else
            {
                ...
                animation = AnimationUtils.loadAnimation(HuiFuCashActivity.this,
    ...
    private class myWebClient extends WebViewClient
    {
        ...
        {
            Builder builder = new Builder(HuiFuCashActivity.this);
            builder.setTitle("");
