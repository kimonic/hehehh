...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
    ...
    public PagerSlidingTabStrip(Activity context)
    {
        this(context, null);
            ...
            int defStyle)
    {
        ...
        tabPadding = (int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, tabPadding, dm);
        dividerWidth = (int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, dividerWidth, dm);
        tabTextSize = (int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_SP, tabTextSize, dm);
        ...
        indicatorColor = a.getColor(
                R.styleable.PagerSlidingTabStrip_indicatorColor,
                indicatorColor);
        underlineColor = a.getColor(
                R.styleable.PagerSlidingTabStrip_underlineColor,
                underlineColor);
        dividerColor = a.getColor(R.styleable.PagerSlidingTabStrip_dividerColor,
                dividerColor);
        ...
        dividerPadding = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pagedividerPadding,
                dividerPadding);
        ...
        textAllCaps = a.getBoolean(
                R.styleable.PagerSlidingTabStrip_pagetextAllCaps, textAllCaps);
    ...
    private void addTextTab(final int position, String title)
    {
        ...
        {
            tab.setTextColor(getResources().getColor(R.color.textcolor));
        }
        tab.setSingleLine();
        tab.setTag(position);
        tab.setOnClickListener(new OnClickListener()
        {
            ...
            {
                if (mOnPage2TopListener != null
                        && pager.getCurrentItem() == (Integer) v.getTag())
                {
    ...
    private void updateTabStyles()
    {
        ...
        for (int i = 0; i < tabCount; i++)
        {
            ...
            if (shouldExpand)
            {
                ...
                {
                    tabsContainer.getChildAt(h)
                            .setLayoutParams(expandedTabLayoutParams);
                }
            }
            else
            {
            ...
            if (v instanceof TextView)
            {
                ...
                if (textAllCaps)
                {
                    ...
                    {
                        tab.setText(
                                tab.getText().toString().toUpperCase(locale));
                    }
                }
            }
        }
    ...
    private class PageListener implements OnPageChangeListener
    {
        ...
        public void onPageSelected(int position)
        {
            ...
            for (int i = 0; i <= pager.getOffscreenPageLimit(); i++)
            {
    ...
    public void hiddenOrinvisibleUnReadImg(int position, boolean isInvisible)
    {

        for (int i = 0; i < tabsContainer.getChildCount(); i++)
        {
            RelativeLayout relativeLayout = (RelativeLayout) tabsContainer
                    .getChildAt(i);
            for (int j = 0; j < relativeLayout.getChildCount(); j++)
            {
                if (relativeLayout.getChildAt(j) instanceof ImageView
                        && (Integer) relativeLayout.getChildAt(j)
                                .getTag() == position)
                {
                    if (isInvisible)
                    {
                        relativeLayout.getChildAt(j)
