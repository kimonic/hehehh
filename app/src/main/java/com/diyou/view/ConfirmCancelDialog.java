        ...
        implements android.view.View.OnClickListener
{
    ...
    public ConfirmCancelDialog(Activity context, String title, String subtitle)
    {
    ...
    public ConfirmCancelDialog(Activity context, int titleId, int subtitleId){
        this(context, context.getString(titleId), context.getString(subtitleId));
    }
