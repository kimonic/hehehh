...
public class YiBaoUnbindBankCardActivity extends BaseActivity
        implements OnClickListener
{
    ...
    private void initActionBar()
    {
        ...
        tvTitle.setText(R.string.yibao_unbind_card_title);
        ...
        public void onProgressChanged(WebView view, int newProgress)
        {
            ...
            else
            {
                ...
                animation = AnimationUtils.loadAnimation(
                        YiBaoUnbindBankCardActivity.this, R.anim.web_animation);
                // 运行动画 animation
    ...
    private class myWebClient extends WebViewClient
    {
        ...
        {
            if(url.contains(Constants.STATUS_UNBINDCARD_SUCCESS)){
                ToastUtil.show(R.string.remind_unbind_succeed);
                startActivity(new Intent(YiBaoUnbindBankCardActivity.this, BankCardManagerActivity.class));
                finish();
            }else if(url.contains(Constants.STATUS_UNBINDCARD_FAIL)){
                ToastUtil.show(R.string.remind_unbind_fail);
                finish();
