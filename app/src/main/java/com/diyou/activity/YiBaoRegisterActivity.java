...
public class YiBaoRegisterActivity extends BaseActivity
    ...
    private void initActionBar() {
        ...
        tvTitle.setText(R.string.yibao_register_title);
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            if (newProgress < 100) {
                ...
                animation = AnimationUtils.loadAnimation(
                        YiBaoRegisterActivity.this, R.anim.web_animation);
                // 运行动画 animation
    ...
    private class myWebClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            if (url.contains(Constants.STATUS_REGISTER_SUCCESS)) {
                startActivity(new Intent(YiBaoRegisterActivity.this, MyPayAccountActivity.class));
                finish();
        ...
        private void showDialog(String string) {
            Builder builder = new Builder(YiBaoRegisterActivity.this);
            builder.setTitle("");
    ...
    private void initData() {
        ...
        HttpUtil.post(UrlConstants.TRUST_REGISTER, map,
