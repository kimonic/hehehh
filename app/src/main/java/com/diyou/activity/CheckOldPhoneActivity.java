        ...
        implements OnClickListener
{
    ...
    private void initView()
    {
        ...
        TextView tvHidePhone = (TextView) findViewById(
                R.id.tv_phone_code_msg_account);
        TextView tvHideDisplay = (TextView) findViewById(
                R.id.tv_phone_bind_display);
        tvHidePhone.setText(StringUtils.getHidePhone(mPhoneNum));
        tvHideDisplay.setText(StringUtils.getHidePhone(mPhoneNum));
    ...
    private void initActionBar()
    {
        ...
        tvTitle.setText(R.string.phone_change_check_old);
    ...
    private void requestVerifyOld()
    {
        ...
        else if (mVerifyCode.equals(StringUtils.getString(mEtCode)))
        {
...
//                             mVerifyCode=str;
                            ...
                            downButton.init(CheckOldPhoneActivity.this,
                                    mBtnSend);
                            downButton.start();
