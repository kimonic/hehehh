...
public class YiBaoRechargeActivity extends BaseActivity
        implements OnClickListener
{
    ...
    private void initActionBar()
    {
        ...
        tvTitle.setText(R.string.yibao_recharge_title);
        ...
        public void onProgressChanged(WebView view, int newProgress)
        {
            ...
            else
            {
                ...
                animation = AnimationUtils.loadAnimation(
                        YiBaoRechargeActivity.this, R.anim.web_animation);
                // 运行动画 animation
    ...
    private class myWebClient extends WebViewClient
    {
        ...
        {
            if(url.contains(Constants.STATUS_RECHARGE_SUCCESS)){
                ToastUtil.show(R.string.remind_recharge_succeed);
                startActivity(new Intent(YiBaoRechargeActivity.this, RechargeRecordActivity.class));
                finish();
            }else if(url.contains(Constants.STATUS_RECHARGE_FAIL)){
                ToastUtil.show(R.string.remind_recharge_fail);
                finish();
    ...
    private void initData()
    {
        ...
        map.put("payment_type", mPaymentType);
        HttpUtil.post(UrlConstants.YIBAO_RECHARGE, map,
