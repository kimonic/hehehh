 ...
 */
public class IAgreementActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void intiView() {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                if (webViewStatus) {
                    ...
                    mLoadinglayout.setOnStopLoading(
                            IAgreementActivity.this, webview);
                } else {
                    mLoadinglayout.setVisibility(View.VISIBLE);
            ...
            public void onReceivedError(WebView view, int errorCode,
                ...
                webViewStatus = false;
                mLoadinglayout.setOnLoadingError(IAgreementActivity.this,
                        webview);
