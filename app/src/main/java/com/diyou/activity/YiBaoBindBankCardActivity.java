...
public class YiBaoBindBankCardActivity extends BaseActivity
        implements OnClickListener
{
    ...
    private void initActionBar()
    {
        ...
        tvTitle.setText(R.string.yibao_bind_card_title);
        ...
        public void onProgressChanged(WebView view, int newProgress)
        {
            ...
            else
            {
                ...
                animation = AnimationUtils.loadAnimation(
                        YiBaoBindBankCardActivity.this, R.anim.web_animation);
                // 运行动画 animation
    ...
    private class myWebClient extends WebViewClient
    {
        ...
        {
            if(url.contains(Constants.STATUS_BINDCARD_SUCCESS)){
                ToastUtil.show(R.string.remind_bind_succeed);
                MyApplication.getInstance().getBankCardManagerActivity().closeBankCardManagerActivity();
                startActivity(new Intent(YiBaoBindBankCardActivity.this, BankCardManagerActivity.class));
                finish();
            }else if(url.contains(Constants.STATUS_BINDCARD_FAIL)){
                ToastUtil.show(R.string.remind_bind_fail);
                finish();
    ...
    private void initData()
    {
        ...
        HttpUtil.post(UrlConstants.YIBAO_BIND_CARD, map,
