...
public class ChiPullToRefreshListView
        extends PullToRefreshAdapterViewBase<ListView>
{
    ...
    public ChiPullToRefreshListView(Context context)
    {
        super(context);
    }

    public ChiPullToRefreshListView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }

    public ChiPullToRefreshListView(Context context, Mode mode)
    {
        super(context, mode);
    }
    ...
    protected void handleStyledAttributes(TypedArray a)
    {
        ...
        mListViewExtrasEnabled = a.getBoolean(
                R.styleable.PullToRefresh1_ptrListViewExtrasEnabled1, true);
    ...
    final class InternalListViewSDK9 extends InternalListView
    {
                ...
                int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent)
        {
            ...
            OverscrollHelper.overScrollBy(ChiPullToRefreshListView.this, deltaX,
            ...
            implements EmptyViewMethodAccessor
    {
        ...
        {
            ChiPullToRefreshListView.this.setEmptyView(emptyView);
        }
