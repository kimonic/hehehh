...
public class IndicatorLayout extends FrameLayout implements AnimationListener
{
    ...
    public IndicatorLayout(Context context, PullToRefreshBase.Mode mode)
    {
        ...
        {
        case PULL_FROM_END:
            inAnimResId = R.anim.slide_in_from_bottom1;
            outAnimResId = R.anim.slide_out_to_bottom1;
            setBackgroundResource(R.drawable.indicator_bg_bottom1);
        ...
        case PULL_FROM_START:
            inAnimResId = R.anim.slide_in_from_top1;
            outAnimResId = R.anim.slide_out_to_top1;
            setBackgroundResource(R.drawable.indicator_bg_top1);
            break;
        }
