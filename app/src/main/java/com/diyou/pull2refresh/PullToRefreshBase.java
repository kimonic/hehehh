        ...
        implements IPullToRefresh<T>
{
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.PullToRefresh1);

        if (a.hasValue(R.styleable.PullToRefresh1_ptrMode1))
        {
            mMode = Mode.mapIntToValue(
                    a.getInteger(R.styleable.PullToRefresh1_ptrMode1, 0));
        }

        if (a.hasValue(R.styleable.PullToRefresh1_ptrAnimationStyle1))
        {
            mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(
                    R.styleable.PullToRefresh1_ptrAnimationStyle1, 0));
        }
         ...
         */
        if (a.hasValue(
                R.styleable.PullToRefresh1_ptrRefreshableViewBackground1))
        {
            ...
            if (null != background)
            {
                ...
                .hasValue(R.styleable.PullToRefresh1_ptrAdapterViewBackground1))
        {
            Utils.warnDeprecation("ptrAdapterViewBackground",
                    "ptrRefreshableViewBackground");
            Drawable background = a.getDrawable(
                    R.styleable.PullToRefresh1_ptrAdapterViewBackground1);
            if (null != background)
            {
                mRefreshableView.setBackgroundDrawable(background);
            }
        ...
        if (a.hasValue(R.styleable.PullToRefresh1_ptrOverScroll1))
        {
            mOverScrollEnabled = a.getBoolean(
                    R.styleable.PullToRefresh1_ptrOverScroll1, true);
        }

        if (a.hasValue(
                R.styleable.PullToRefresh1_ptrScrollingWhileRefreshingEnabled1))
        {
